        ...
        <div className="col-md-3 col-lg-2 d-flex flex-column min-vh-100 bg-light sidebar">
            <div className='logo'>
                <Link className="nav-link" to="/home">
                    <img src={Logo} alt="Instagram" className="logo" to="/home"/>
                </Link>
            </div>
            <ul className="nav flex-column nav-flex-grow">
                <li className="nav-item">
                    <Link className="nav-link" to="/home" ><FontAwesomeIcon icon={faHome} className="fa-icon" /> Página Inicial</Link>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                    <Link className="nav-link" to="/perfil"><FontAwesomeIcon icon={faUser} className="fa-icon" /> Perfil</Link>
                </li>
                <li className="nav-item">
